...
def normal():
    ...
    def onclik(i,j,plateau_de_bombe, plateau_win):
        ...
        if plateau_de_bombe[i][j]==9:
            ...
            def loose():
                ...
                frame_loose_score = tk.Frame(windows_normal)
            ...
            name_player = tk.Entry(windows_normal, font=("yellowstone", 20), borderwidth=4, fg="gray", bg="white")
            name_player.pack(pady=10)
            name_player.insert(0, "Entrez votre pseudo...")

            name_player.bind("<FocusIn>", replace_entry)

            btn_valid_entry = tk.Button(windows_normal, command=confirme_entry, text="Valider", relief="raised",
                                        bg="#B1A8A8", fg="blue", borderwidth=5, font=("Retro Gaming", 25))
            btn_valid_entry.pack(pady=10)

            frame_name_score = tk.Frame(windows_normal, bg="#B1A8A8")
        ...
        if verif(plateau_win) == True:
            ...
            def win():
                ...
                frame_win_score = tk.Frame(windows_normal)
                ...
                exit_game = tk.Button(windows_normal, text="QUITTER", pady=11, relief="raised", bg="#B1A8A8", fg="blue",
    ...
    cadre_interrogation = tk.Frame(windows_normal, bg="#B1A8A8")
    ...
    cadre_flags = tk.Frame(windows_normal, bg="#B1A8A8")
    cadre_flags.pack()
    ...
    cadre_suppr_affiche = tk.Frame(windows_normal, bg="#B1A8A8")
